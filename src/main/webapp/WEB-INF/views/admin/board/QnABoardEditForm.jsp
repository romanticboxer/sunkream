   ...
   <div align="center" class="basicFont">
      <form name="QnABoardEdit" method="post" action="QnABoardEdit.admin"
         ...
         <td colspan = "2"><h3>게시글 수정</h3>
            ...
            <tr>
               <th>카테고리</th>
               <th><select class = "form-select" style = "display:inline;width:30%;" id="qna_cate" name="qna_cate"
                  onchange="cateSelect()">
               ...
               </select> <select id="qna_subCate"  class = "form-select" style = "display:inline;width:30%;" name="qna_subCate">
